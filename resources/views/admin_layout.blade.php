				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{route('add_cat')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Category</span></a></li>
								<li><a class="submenu" href="{{route('manage_cat')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Category</span></a></li>
								
							</ul>	
						</li>
						<li><a href="{{route('donars_confirm')}}"><i class="icon-edit"></i><span class="hidden-tablet">Donars</span></a></li>
						<li><a href="{{route('donation_products')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Donation-Products</span></a></li>
						<li><a href="{{route('donation_request')}}"><i class="icon-font"></i><span class="hidden-tablet"> donation_request</span></a></li>
